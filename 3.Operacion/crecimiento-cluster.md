...
La herramienta *kafka-reassign-partitions.sh* nos permite generar este fichero de manera automática:
  ...
  ```
  Este comando generá una salida como la que utilizamos en la sesión anteriormente, copiamos la salida y creamos un fichero *mover-replicas.json*.
  ```json
